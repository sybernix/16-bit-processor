...
vlog -work work clkop_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax clkop_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.clkop_tb work.glbl
