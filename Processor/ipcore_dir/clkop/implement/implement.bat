...
xst -ifn xst.scr
move clkop_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clkop_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clkop_exdes.ucf clkop_exdes

echo 'Running map'
map -timing -pr b clkop_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clkop_exdes -w routed.ncd routed.v
cd ..
